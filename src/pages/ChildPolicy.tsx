...
const ChildPolicy = () => {
 const navigate = useNavigate();
    ...
    <>
    <Layout>
        <div className='flex flex-col items-start px-6 md:px-12 lg:px-20 gap-5 space-y-4'>
        ...
        <div className='flex flex-col items-start pt-5 pb-10 px-6 md:px-12 lg:px-20 gap-5'>
            ...
            <div className='leading-[2rem] lg:leading-[2.5rem] tracking-tight text-base lg:text-lg pb-10 w-full lg:w-[80vw]'>
                ...
                <ul className="list-disc pl-6 space-y-4">
                    <li>Never abuse and/or exploit a child or act/behave in any way that places a child at risk of harm.</li>
                    <li>
                    Report any child abuse and protection concerns they have in accordance with the document Reporting and Responding to
                    Child Protection Issues in The Learning Craft® (see Annex I below). This is a mandatory requirement for Staff. Failure to do so
                    may result in disciplinary action.
                    </li>
                    <li>Cooperate fully and confidentially in any investigation of concerns and allegations.</li>
                    <li>Contribute to an environment where children are respected and encouraged to discuss their concerns and rights.</li>
                    <li>
                    Always ask permission from children (or, in the case of young children, their parent or guardian) before taking images (e.g.
                    photographs, videos) of them. Respect their decision to say no to an image being taken. Ensure that any images taken of
                    children are respectful (For example: children should have adequate clothing that covers up the sexual organs. Images of
                    children in sexually suggestive poses or that in any way impact negatively on their dignity or privacy are not acceptable).
                    Stories and images of children should be based on the child's best interest.
                    </li>
                    <li>
                    Be aware that where concerns exist about the conduct of Staff or Associates in relation to child protection and/or where
                    there has been a breach of the Child Protection Policy, this will be investigated under this policy either: by consideration of
                    referral to statutory authorities for criminal investigation under the law of the country in which they work; and/or by The
                    Learning Craft® in accordance with disciplinary procedures. This may result in disciplinary sanctions and/or dismissal for Staff.
                    </li>
                    <li>
                    Be aware that, if a legitimate concern about suspected child abuse is raised, which proves to be unfounded on investigation,
                    no action will be taken against the reporter. However, any employee/associate who knowingly makes false and malicious
                    accusations will face disciplinary action, up to and including dismissal.
                    </li>
                </ul>
              </div>
            <hr className="border-t border-gray-200 w-screen relative left-1/2 -translate-x-1/2" />
            <div className='flex flex-col items-start pt-5 pb-10 px-2 lg:px-5 gap-5'>
                ...
                <div className='leading-[2rem] lg:leading-[2.5rem] tracking-tight text-base lg:text-lg pb-10'>
                    ...
                    <div className="space-y-4">
                        <p>
                        <span>A.</span>{"  "}Any known or suspected case of abuse, exploitation, or harassment must always be brought to the attention of your Line Manager who then
                        informs the Administration and Human Resources Manager.
                        </p>
                        <p>
                        <span>B.</span>{"  "}In the event that staff members have concerns that are related to the behaviour of their Line Manager and/or the Administration and Human
                        Resources Manager, they should raise these concerns directly with an alternative Manager and/or The Learning Craft® Chief Executive Officer or Chief
                        Operations Officer.
                        </p>
                        <p>
                        <span>C.</span>{"  "}The reporting of a concern will result in a confidential, thorough and prompt investigation being conducted. Such investigations may reduce the level
                        of concern or lead to the realisation that further action is appropriate.
                        </p>
                        <p>
                        <span>D.</span>{"  "}People reporting possible violations and/or involved in such investigations – including the subject of the complaint – will be protected against any
                        form of intimidation, threats, reprisal or retaliation resulting from the alleged incident. If any member of staff is found intimidating or retaliating against a
                        person making a complaint or assisting in an investigation, disciplinary action – up to and including dismissal – will be imposed.
                        </p>
                        <p>
                        <span>E.</span>{"  "}Any intentionally false, malicious or vexatious statement, misrepresentation or accusation against another staff member or third party will be
                        considered gross misconduct.
                        </p>
                        <p>
                        <span>F.</span>{"  "}All information related to the case will be held in the strictest confidence, recorded and the record held in a secure location with the Manager and
                        the Human Resources Manager. It will be disclosed only on a need-to-know basis in order to resolve the matter.
                        </p>
                    </div>
                  </div>
            </div>
